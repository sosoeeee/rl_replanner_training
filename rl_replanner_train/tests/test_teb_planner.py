...
for x, y, r in circular_obstacles_params:
    circular_obstacles.append(cpp_utils.CircularObstacle(x, y, r))
    marker = Marker()
...
tebPlanner.initialize(tebConfig, circular_obstacles, viaPoints)
startPoint = cpp_utils.PoseSE2(0.0, 0.0, np.pi)
endPoint = cpp_utils.PoseSE2(4.0, 1.0, np.pi)
