# 在~/rl_replanner_training/rl_replanner_train/maps下运行
...
res_status, costmap_cpp = cpp_utils.loadMap("./rl_replanner_train/maps/square_map/square_map_2.yaml") # 1.修改地图路径
...
traj_generator.initialize(
    map_file="./rl_replanner_train/maps/square_map/square_map_2.yaml",  # 2.修改地图路径
...
startPoint = cpp_utils.Point(-9.0, -9.0)
endPoint = cpp_utils.Point(9.0, 9.0)

# 轨迹文件
data_dir = "rl_replanner_train/data/square_map"
